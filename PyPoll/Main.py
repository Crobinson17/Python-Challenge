...
csvpath = os.path.join("03-Python_HW_Instructions_PyPoll_Resources_election_data.csv")
csvpath_output = ("03-Python_HW_Instructions_PyPoll_Resources_election_data.csv.txt")
